...
public class Owner extends VBox {
    ...
    private Label lName, lStreet, lCity, lCap, lOwner, lPrice, lNRoom;
    private TextField tfName, tfStreet, tfCity, tfCap, tfOwner, tfPrice, tfNRoom;
    ...
    public Owner(Main main){
        ...
        // FORM CREATION
        GridPane grid = new GridPane(2,7);
        ...
        this.publish.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                String db = "src/main/resources/database.csv";
                String tutto = "";
                ...
                try {
                    ...
                    new Alert(Alert.AlertType.CONFIRMATION, "Salvato!").show();
